...
public abstract class AdbImageBase {
    ...
    public static AdbImageBase loadImageFromFile(String path) {
    ...
    public boolean sameAs(AdbImageBase other, double percent) {
    ...
    public AdbImageBase getSubImage(int x, int y, int w, int h) {
        BufferedImage image = this.getBufferedImage();
