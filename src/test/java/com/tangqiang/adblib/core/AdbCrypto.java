...
public class AdbCrypto {
    ...
    private static Logger logger = LoggerFactory.getLogger(AdbCrypto.class);
    /**
    ...
    public static AdbCrypto loadAdbKeyPair(AdbBase64 base64, File privateKey, File publicKey) throws IOException, NoSuchAlgorithmException, InvalidKeySpecException {
        logger.info("loadAdbKeyPair privateKey:" + privateKey.getAbsolutePath() + "  publicKey:" + publicKey.getAbsolutePath());
    ...
    public void saveAdbKeyPair(File privateKey, File publicKey) throws IOException {
        File folder = privateKey.getParentFile();
        if (!folder.exists() || !folder.isDirectory()) {
            folder.mkdirs();
        }
        logger.info("saveAdbKeyPair privateKey:" + privateKey.getAbsolutePath() + "  publicKey:" + publicKey.getAbsolutePath());
