...
public class AdbStream implements Closeable {
    ...
    void sendReady() throws IOException {
        ...
        logger.debug("Send a package: Ready  localId:"+localId + " remoteId:" + remoteId);
    ...
    public void write(byte[] payload, boolean flush) throws IOException, InterruptedException {
        ...
        logger.debug("Send a package: Write  localId:" + localId + "  remoteId:" + remoteId + "  payload:" + payload.length);
        adbConn.outputStream.write(packet);
    ...
    public void close() throws IOException {
        ...
        logger.debug("Send a package: Close  localId:" + localId + "  remoteId:" + remoteId);
        adbConn.outputStream.write(packet);
        adbConn.outputStream.flush();
    }
